...
<div class="login-box">
  <div class="login-logo">
    <div style="color: white; font-size: 160%; color: white;" class="fa fa-truck"> <span style="font-weight: bold;">CBA</span></div>
    <br/>
    <small style="color: white; width: 100%; font-size: 22px; color: white;">( PT. Citra Baja Autotruck )</small>
    <!-- <img src="<?php echo base_url() ?>assets/gambar/login.png" style="width: 350px;"> -->
    <!--<a href="<?php //echo base_url() ?>adminLTE/index2.html"><b>Gembongan</b> System</a>-->
  </div>
  <!-- /.login-logo -->
