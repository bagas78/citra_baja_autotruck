          ...
          <div class="box">
            <div class="box-body box-profile">
              <?php if (@$data[0]['user_foto'] == ''): ?>
                <img class="profile-user-img img-responsive" src="<?php echo base_url() ?>assets/gambar/user/no.jpg" alt="User profile picture" style="margin-bottom: 5%;">
              <?php else: ?>
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  ...
                  <a><?php echo @$data[0]['detail_departement']; ?></a>
                </li>
              </ul>
              ...
              <div class="active tab-pane" id="settings">
                <form method="post" action="<?php echo base_url() ?>profile/update/<?php echo $this->session->userdata('id'); ?>" class="form-horizontal" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="nik" class="form-control" value="<?php echo @$data[0]['detail_nik']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="departement" class="form-control" value="<?php echo @$data[0]['detail_departement']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">TTL</label>
                    <div class="col-sm-10">
                      <input type="text" name="ttl" class="form-control" value="<?php echo @$data[0]['detail_ttl']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
